...
public static class SystemNamespaceType
{
    ...
    private static Lazy<ImmutableArray<FunctionOverload>> FunctionOverloadsLazy { get; }
        = EnumerableExtensions.CreateLazyArray(GetFunctionOverloads);

    private static Lazy<ImmutableArray<BannedFunction>> BannedFunctionsLazy { get; }
        = EnumerableExtensions.CreateLazyArray(GetBannedFunctions);

    private static Lazy<ImmutableArray<Decorator>> SystemDecoratorsLazy { get; }
        = EnumerableExtensions.CreateLazyArray(GetDecorators);

    private static Lazy<ImmutableArray<Decorator>> UserDefinedTypesEnabledDecoratorsLazy { get; }
        = EnumerableExtensions.CreateLazyArray(GetUserDefinedTypesEnabledDecorators);

    private static Lazy<ImmutableArray<TypeTypeProperty>> AmbientSymbolsLazy { get; }
        = EnumerableExtensions.CreateLazyArray(GetAmbientSymbols);

    private static IEnumerable<FunctionOverload> GetFunctionOverloads()
    {
    ...
    private static IEnumerable<BannedFunction> GetBannedFunctions()
    {
        /*
        ...
        yield return new BannedFunction("variables", builder => builder.VariablesFunctionNotSupported());
        yield return new BannedFunction("parameters", builder => builder.ParametersFunctionNotSupported());
        yield return new BannedFunction("if", builder => builder.IfFunctionNotSupported());
        yield return new BannedFunction("createArray", builder => builder.CreateArrayFunctionNotSupported());
        yield return new BannedFunction("createObject", builder => builder.CreateObjectFunctionNotSupported());

        yield return BannedFunction.CreateForOperator("add", "+");
        yield return BannedFunction.CreateForOperator("sub", "-");
        yield return BannedFunction.CreateForOperator("mul", "*");
        yield return BannedFunction.CreateForOperator("div", "/");
        yield return BannedFunction.CreateForOperator("mod", "%");
        yield return BannedFunction.CreateForOperator("less", "<");
        yield return BannedFunction.CreateForOperator("lessOrEquals", "<=");
        yield return BannedFunction.CreateForOperator("greater", ">");
        yield return BannedFunction.CreateForOperator("greaterOrEquals", ">=");
        yield return BannedFunction.CreateForOperator("equals", "==");
        yield return BannedFunction.CreateForOperator("not", "!");
        yield return BannedFunction.CreateForOperator("and", "&&");
        yield return BannedFunction.CreateForOperator("or", "||");
        yield return BannedFunction.CreateForOperator("coalesce", "??");
    }
    ...
    private static IEnumerable<Decorator> GetDecorators()
    {
    ...
    private static IEnumerable<Decorator> GetUserDefinedTypesEnabledDecorators()
    {
    ...
    private static IEnumerable<TypeTypeProperty> GetAmbientSymbols()
    ...
    {
        var decorators = SystemDecoratorsLazy.Value;
        if (featureProvider.UserDefinedTypesEnabled)
        {
            decorators = decorators.AddRange(UserDefinedTypesEnabledDecoratorsLazy.Value);
        }

        // This type is recomputed on every keypress - use lazy statics to avoid unneccesary computation
        return new NamespaceType(
            aliasName,
            Settings,
            AmbientSymbolsLazy.Value,
            FunctionOverloadsLazy.Value,
            BannedFunctionsLazy.Value,
            decorators,
